...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': '1096895094728-f1vh9r0o6m61b2bh2qjpkrcujv6crgla.apps.googleusercontent.com',
            'secret': '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',
            'key': ''
        },
        'SCOPE': [
            'profile',
